...
esp_err_t ssd1619_read_lut(int pin_data, int pin_clk, int pin_cs, int pin_dc, int pin_reset, int pin_busy) {
    ...
    bitbang_write_cmd(pin_data, pin_clk, pin_dc, SSD1619_CMD_SW_RESET);
    ...
    gpio_set_level(pin_cs, false);
    bitbang_write_cmd(pin_data, pin_clk, pin_dc, SSD1619_CMD_SET_ANALOG_BLOCK_CONTROL);
    bitbang_write_data(pin_data, pin_clk, pin_dc, 0x54);
    gpio_set_level(pin_cs, true);
    vTaskDelay(10 / portTICK_PERIOD_MS);

    gpio_set_level(pin_cs, false);
    bitbang_write_cmd(pin_data, pin_clk, pin_dc, SSD1619_CMD_SET_DIGITAL_BLOCK_CONTROL);
    bitbang_write_data(pin_data, pin_clk, pin_dc, 0x3B);
    gpio_set_level(pin_cs, true);
    vTaskDelay(10 / portTICK_PERIOD_MS);

    gpio_set_level(pin_cs, false);
    bitbang_write_cmd(pin_data, pin_clk, pin_dc, SSD1619_CMD_UNKNOWN_1);
    ...
    gpio_set_level(pin_cs, false);
    bitbang_write_cmd(pin_data, pin_clk, pin_dc, SSD1619_CMD_BOOSTER_SOFT_START_CONTROL);
    ...
    gpio_set_level(pin_cs, false);
    bitbang_write_cmd(pin_data, pin_clk, pin_dc, SSD1619_CMD_DRIVER_OUTPUT_CONTROL);
    ...
    gpio_set_level(pin_cs, false);
    bitbang_write_cmd(pin_data, pin_clk, pin_dc, SSD1619_CMD_DATA_ENTRY_MODE_SETTING);
    bitbang_write_data(pin_data, pin_clk, pin_dc, 0x01);
    gpio_set_level(pin_cs, true);
    vTaskDelay(10 / portTICK_PERIOD_MS);

    gpio_set_level(pin_cs, false);
    bitbang_write_cmd(pin_data, pin_clk, pin_dc, SSD1619_CMD_SET_RAM_X_ADDRESS_LIMITS);
    ...
    gpio_set_level(pin_cs, false);
    bitbang_write_cmd(pin_data, pin_clk, pin_dc, SSD1619_CMD_SET_RAM_Y_ADDRESS_LIMITS);
    bitbang_write_data(pin_data, pin_clk, pin_dc, (screen_height - 1) & 0xFF);
    bitbang_write_data(pin_data, pin_clk, pin_dc, ((screen_height - 1) >> 8));
    gpio_set_level(pin_cs, true);
    vTaskDelay(10 / portTICK_PERIOD_MS);
    ...
    gpio_set_level(pin_cs, false);
    bitbang_write_cmd(pin_data, pin_clk, pin_dc, SSD1619_CMD_BORDER_WAVEFORM_CONTROL);
    bitbang_write_data(pin_data, pin_clk, pin_dc, 0x01);
    gpio_set_level(pin_cs, true);
    vTaskDelay(10 / portTICK_PERIOD_MS);

    gpio_set_level(pin_cs, false);
    bitbang_write_cmd(pin_data, pin_clk, pin_dc, SSD1619_CMD_DISPLAY_UPDATE_CONTROL_1);
    bitbang_write_data(pin_data, pin_clk, pin_dc, 0b00001000);
    gpio_set_level(pin_cs, true);
    vTaskDelay(10 / portTICK_PERIOD_MS);

    gpio_set_level(pin_cs, false);
    bitbang_write_cmd(pin_data, pin_clk, pin_dc, SSD1619_CMD_DISPLAY_UPDATE_CONTROL_2);
    ...
    gpio_set_level(pin_cs, false);
    bitbang_write_cmd(pin_data, pin_clk, pin_dc, SSD1619_CMD_MASTER_ACTIVATION);
    gpio_set_level(pin_cs, true);
    ...
    gpio_set_level(pin_cs, false);
    bitbang_write_cmd(pin_data, pin_clk, pin_dc, SSD1619_CMD_TEMPERATURE_SENSOR_CONTROL);
    ...
    for (int temperature_index = 0; temperature_index < sizeof(temperatures); temperature_index++) {
        ...
        gpio_set_level(pin_cs, false);
        bitbang_write_cmd(pin_data, pin_clk, pin_dc, SSD1619_CMD_TEMPERATURE_SENSOR_WRITE);
